    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <table id="nation">
                ...
                <tr>
                    <td>Manpower</td>
                    <td><cloc:manpower main="${nation2}" population="${nation3}"/></td>
                </tr>
                <tr>
                    <td>Equipment</td>
            ...
            <table id="nation">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="submit"
                                onclick="sendRm(document.getElementById('amountRm').value, <c:out value="${id}"/>);">
                            Send
                        </button>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="submit"
                                onclick="sendOil(document.getElementById('amountOil').value, <c:out value="${id}"/>);">
                            Send
                        </button>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="submit"
                                onclick="sendMg(document.getElementById('amountMg').value, <c:out value="${id}"/>);">
                            Send
                        </button>
                    </td>
                </tr>
