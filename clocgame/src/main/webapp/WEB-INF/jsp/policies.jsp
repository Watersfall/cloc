        ...
        <c:choose>
            ...
            <c:when test="${param['policies'] == 'Economic'}">
                ...
                <tr>
                    ...
                    <td>
                        Build a new factory for your growing population, Consumes 1 Oil and Raw Material to produce 1
                        Manufactured good
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Build a new Nitrogen Fixation plant to blow up other people's populations, consumes 2 Oil and 1
