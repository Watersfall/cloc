 ...
 * @author Chris
 */
@WebServlet(urlPatterns = "/policies/unnitrogenplant")
public class PolicyUnNitrogenPlant extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			{
				if(1 > results.getInt("nitrogenplant"))
				{
					writer.append("<p>You don't have any plants to close!</p>");
				}
				else
				{
					...
					update.execute();
					conn.commit();
					writer.append("<p>You close down a nitrogen plant, forcing hundreds of thousands of workers into unemployment. You monster</p>");
				}
			}
		}
