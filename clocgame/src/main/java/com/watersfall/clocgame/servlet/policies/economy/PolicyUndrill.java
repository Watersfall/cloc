 ...
 * @author Chris
 */
@WebServlet(urlPatterns = "/policies/undrill")
public class PolicyUndrill extends HttpServlet
{
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					update.execute();
					conn.commit();
					writer.append("<p>You close down an oil well, forcing thousands of workers into unemployment. You monster</p>");
				}
			}
		}
