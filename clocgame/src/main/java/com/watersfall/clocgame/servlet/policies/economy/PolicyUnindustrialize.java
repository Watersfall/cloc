 ...
 * @author Chris
 */
@WebServlet(urlPatterns = "/policies/unindustrialize")
public class PolicyUnindustrialize extends HttpServlet
{
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					update.execute();
					conn.commit();
					writer.append("<p>You close down a factory, forcing hundreds of thousands of workers into unemployment. You monster</p>");
				}
			}
		}
