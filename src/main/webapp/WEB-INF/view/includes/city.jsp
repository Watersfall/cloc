				...
				<c:otherwise>
					...
					<ul>
						<li class="cityElements">
							...
							<p>${city.coalMines} coal mines producing ${city.coalMines / 4 } tons of coal per week
								<br>
						...
						<li class="cityElements">
							...
							<p>
									${city.ironMines} iron mines producing ${city.ironMines / 4 } tons of coal per week
								<br>
								(${1 / 4} tons per week per mine)
							</p>
						...
						<li class="cityElements">
							...
							<p>
									${city.oilWells} oil wells producing ${city.oilWells / 4 } tons of oil per week
								<br>
					...
					<ul>
						<li class="cityElements">
							...
							<p>
									${city.industryCivilian} civilian factories producing ${city.industryCivilian / 2 } tons of steel per week
								<br>
								(${1 / 2} tons per week per factory)
							</p>
						...
						<li class="cityElements">
							...
							<p>
									${city.industryMilitary} military factories producing ${city.industryMilitary * 10 } weapons per week
								<br>
						...
						<li class="cityElements">
							...
							<p>
									${city.industryNitrogen} nitrogen factories producing ${city.industryNitrogen / 2 } tons of nitrogen per week
								<br>
								(${1 / 2} weapons per week per factory)
							</p>
					...
					<ul>
						<li class="cityElements">
							...
							<p>
									${city.universities} universities producing ${city.universities * 1 } research per week
								<br>
