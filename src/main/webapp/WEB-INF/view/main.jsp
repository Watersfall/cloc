...
<div class="container"><%@ include file="includes/results.jsp"%>
	...
	<c:if test="${sessionScope.user != null}">
		...
		<div class="nation">
			...
			<img class="flag" src="${pageContext.request.contextPath}/images/flag/<c:out value="${home.cosmetic.flag}"/>" alt="flag">
			<p><c:out value="${home.cosmetic.description}"/></p>
			<img class="leader" src="${pageContext.request.contextPath}/images/portrait/<c:out value="${home.cosmetic.portrait}"/>" alt="flag">
