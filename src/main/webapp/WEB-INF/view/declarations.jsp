...
<div class="container"><%@ include file="includes/results.jsp"%><div class="main">
	<h1>Global Declarations</h1>
		<c:forEach var="declaration" items="${declarations}">
			<table id="nation">
				<tr><td><a href="${pageContext.request.contextPath}/nation/${declaration.sender.id}"><img class="medium" style="margin-right: 1em;" src="${pageContext.request.contextPath}/user/flag/<c:out value="${declaration.sender.flag}"/>" alt="flag"/><c:out value="${declaration.sender.nationName}"/></a></td></tr>
