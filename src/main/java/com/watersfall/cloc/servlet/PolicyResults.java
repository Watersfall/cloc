...
public class PolicyResults extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            {
                check = database.getConnection().prepareStatement("SELECT * FROM cloc WHERE sess=?");
            ...
            else
            {
                ...
                switch(param)
                {
                    case "freemoneycapitalist":
                        statement = database.getConnection().prepareStatement("UPDATE cloc SET budget=budget+1000, economic=economic+5 "
                                + "WHERE sess=?");
                        statement.setString(1, sess);
                        statement.execute();
                        statement.getConnection().close();
                        statement.close();
                        statement = database.getConnection().prepareStatement("UPDATE cloc SET economic=100 WHERE economic>100");
                        statement.execute();
                        statement.getConnection().close();
                        statement.close();
                    ...
                    case "freemoneycommunist":
                        ...
                        statement.getConnection().close();
                        statement.close();
                        statement = database.getConnection().prepareStatement("UPDATE cloc SET economic=0 WHERE economic<0");
                        statement.execute();
                        statement.getConnection().close();
                        statement.close();
                    ...
                    case "drill":
                    {
                        ...
                        {
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET wells=wells+1, budget=budget-? "
                                    + "WHERE sess=?;");
                    ...
                    case "mine":
                    {
                        ...
                        {
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET mines=mines+1, budget=budget-? "
                                    + "WHERE sess=?;");
                            statement.setInt(1, cost);
                            statement.setString(2, sess);
                            statement.execute();
                    ...
                    case "crackdown":
                    {
                        ...
                        {
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET stability=stability+5, approval=approval-3, political=political+5, budget=budget-? "
                                    + "WHERE sess=?");
                            statement.setInt(1, cost);
                            statement.setString(2, sess);
                            statement.execute();
                            statement.getConnection().close();
                            statement.close();
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET stability=100 "
                                    + "WHERE stability>100");
                            statement.execute();
                            statement.getConnection().close();
                            statement.close();
                    ...
                    case "free":
                    {
                        ...
                        else
                        {
                            ...
                            statement.getConnection().close();
                            statement.close();
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET approval=100 "
                                    + "WHERE approval>100");
                            statement.execute();
                            statement.getConnection().close();
                            statement.close();
                    ...
                    case "alignentente":
                    {
                        ...
                        {
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET alignment=-1, budget=budget-? "
                                    + "WHERE sess=?");
                            statement.setInt(1, cost);
                            statement.setString(2, sess);
                            statement.execute();
                    ...
                    case "alignneutral":
                    {
                        ...
                        {
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET alignment=0, budget=budget-? "
                                    + "WHERE sess=?");
                            statement.setInt(1, cost);
                            statement.setString(2, sess);
                            statement.execute();
                    ...
                    case "conscript":
                        ...
                        else
                        {
                            ...
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET manpower=manpower-2, army=army+2, training=training-? "
                                    + "WHERE sess=?");
                    ...
                    case "train":
                    {
                        ...
                        {
                            statement = database.getConnection().prepareStatement("UPDATE cloc SET training=training+5, budget=budget-? "
                                    + "WHERE sess=?");
                            statement.setInt(1, cost);
                            statement.setString(2, sess);
                            statement.execute();
